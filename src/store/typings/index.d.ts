...
import "./vue";
import { ReturnGetter } from "./utils";
...
export interface StoreTS<State, Getters, Actions, Mutations> {
  readonly state: State;
  // readonly getters: GetterHelper<Getters>;
  readonly getters: ReturnGetter<Getters>;
...
export declare class Store<S> {
  ...
  public subscribeAction<P extends ActionPayload>(fn: (action: P, state: S) => any): () => void;
  public watch<T>(getter: (state: S, getters: any) => T, cb: (value: T, oldValue: T) => void, options?: WatchOptions): () => void;

  public registerModule<T>(path: string, module: Module<T, S>, options?: ModuleOptions): void;
  public registerModule<T>(path: string[], module: Module<T, S>, options?: ModuleOptions): void;
